...
{
    public class SimpleComposer_2500_2015_Before_Reverse
  {
    ...
    public void Initialise(string method2)
    {
        ...
        p.FirstChoice = (p.AllowSingles?3:2) * (p.Methods.Count() - 1);
...
// London?
      ...
      while (true)
      {
        ...
        if (end
            ...
            && maxLeadIndex >= problem.MinLength/32 -1 
