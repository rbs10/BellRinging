                   ...
                   //STD 8
                    "Rutland", "Cassiobury", "Cornwall",   "Bristol", 
                     "Yorkshire","Cambridge", "Superlative" 
                       ,  "Glasgow", "Lindum", "Ashtead","Uxbridge" ,"Jersey", "Preston", "Lessness"
                     /* /
                    "Lincolnshire", "Pudsey" 
                   //,
             ...
             */
            {
                ...
                foreach (var method1_ext in startMethodBits)
                {
                    ...
                    var task = new Task(() =>
                    {
                        ...
                        for (int i2 = 0; i2 < startMethodBits.Count && worthKeeping > 1; ++i2)
                        {
                            worthKeeping = 3;
                                ...
                                for (int i3 = 0; i3 < startMethodBits.Count && worthKeeping > 2; ++i3)
                            {
                                ...
                                if (
                                    ...
                                    for (int i4 = 0; i4 < startMethodBits.Count && worthKeeping > 3; ++i4)
                                {
                                    worthKeeping = 5;
                                    ...
                                    if (
                                        ...
                                        for (int i5 = 0; i5 < startMethodBits.Count && worthKeeping > 4; ++i5)
                                    {
                                        worthKeeping = 6;
                                        ...
                                        if (
                                            ...
                                            for (int i6 = 0; i6 < startMethodBits.Count && worthKeeping > 5; ++i6)
                                        {
                                            //worthKeeping = 6;
                                            ...
                                            if ( cyclicPartEnds.Contains(mb6.leadEnd1)
                                                // select for single method only
                                               // && methodBits.Select(m=>m.method ).Distinct().Count() == 1
                                                )
                                            {
                                                try
                                                {
                                                    ...
                                                    //if (score > 190) //bestScore)
                                                    if ( mb1.method == mb2.method && mb2.method == mb3.method &&
                                                        mb3.method == mb4.method && mb4.method == mb5.method && mb5.method == mb6.method )
                                                    {


                                                        var search = new CyclicSearch();
